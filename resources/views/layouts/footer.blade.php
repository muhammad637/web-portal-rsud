        ...
        <div class="row mb-5">
          <div class="col-md-3">
            ...
            <ul class="ftco-footer-social list-unstyled float-md-left float-lft ">
              <li class="ftco-animate"><a href="https://twitter.com/rsudblambangan"><span class="icon-twitter"></span></a></li>
              <li class="ftco-animate"><a href="https://www.facebook.com/people/BLAMBANGAN-PUBLIC-HOSPITAL/100064334303425/"><span class="icon-facebook"></span></a></li>
              <li class="ftco-animate"><a href="https://www.instagram.com/rsudblambangan/"><span class="icon-instagram"></span></a></li>
            </ul>
          </div>
          <div class="col-md-2">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="#" class="py-2 d-block">Pasien & Kunjungan</a></li>
          ...
          <div class="col-md-4 pr-md-4">
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(images/wkwkwk.jpg);"></a>
                <div class="text">
                  <h3 class="heading"><a href="#">7 Manfaat Tertawa Bagi Kesehatan, Redakan .....</a></h3>
                  <div class="meta">
                    <div><a href="#"><span class="icon-calendar"></span> Agustus 08, 2023</a></div>
