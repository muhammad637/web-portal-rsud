    ...
    <div class="col-sm-12">
        <div class="form-group">
            <div class="select-wrap">
                ...
                <select name="spesialis_id" id="" class="form-select form-control"
                    aria-placeholder="Spesialis">
                    <option value="" class="text-dark">Pilih Spesialis
                    </option>
                    @foreach ($Spesialis as $spesialis)
                        <option value="{{ $spesialis->id }}" class="text-dark">{{ $spesialis->nama_spesialis }}
                        </option>
                    @endforeach
                </select>
            </div>
