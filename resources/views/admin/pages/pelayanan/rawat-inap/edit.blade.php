...
@section('content-admin')
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('admin.rawatInap.update', ['rawatInap' => $rawatInap->slug]) }}" method="post"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama"
                        id="nama" value="{{ old('nama', $rawatInap->nama) }}">
                    @error('nama')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('slug') is-invalid @enderror" name="slug"
                        id="slug" readonly value="{{ old('slug', $rawatInap->slug) }}">
                    @error('slug')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <img id="displayedImage" class="img-fluid w-50"
                        src="{{ old('gambar', asset('storage/' . $rawatInap->gambar)) }}" alt="Gambar yang Dipilih">
                </div>
                <div class="mb-3">
                    <label for="" class="form-label">gambar</label>
                    <input type="file" class="form-control @error('gambar') is-invalid @enderror" name="gambar"
                        id="gambar" id="gambar" accept="image/*" value="{{ old('gambar', $rawatInap->gambar) }}">
                    @error('gambar')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input id="deskripsi" placeholder="masukkan deskripsi berita" type="hidden" name="deskripsi"
                        value="{{ old('deskripsi', $rawatInap->deskripsi) }}">
                    <trix-editor input="deskripsi"></trix-editor>
                </div>

                <a class="btn btn-warning" href="{{ route('admin.rawatInap') }}">Kembali</a>
