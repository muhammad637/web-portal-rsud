            ...
            <div class="container" data-scrollax-parent="true">
                <div class="row slider-text align-items-end">
                    <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                        ...
                        <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Profil RSUD
                            Blambangan</h1>
                    </div>
                </div>
            </div>
                    ...
                    <div class="about-wrap">
                        ...
                        <div class="list-services d-flex ftco-animate text-center">
                            <div class="text-center">
                                <p>Meningkatkan akses pelayanan kesehatan melalui diversifikasi layanan serta pengembangan
                                    inovasi unggulan di rumah sakit</p>
                            </div>
                        </div>
                        <div class="list-services d-flex ftco-animate">
                            <div class="text-center">
                                <p>Meningkatkan tata kelola manajemen rumah sakit serta pemenuhan kebutuha sarana dan
                                    prasarana sesuai dengan standar pelayanan rumah sakit</p>
                            </div>
                        </div>
                        <div class="list-services d-flex ftco-animate">
                            <div class="text-center">
                                <p>Menyelenggarakan pendidikan dan pelatihan yang berkualitas serta memfasilitasi penelitian
                                    untuk meningkatkan ilmu pengetahuan dan teknologi yang bermanfaat bagi masyarakat serta
