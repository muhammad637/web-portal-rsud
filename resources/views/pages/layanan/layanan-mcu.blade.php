...
<section class="home-slider owl-carousel">
        ...
        <div class="container" data-scrollax-parent="true">
          <div class="row slider-text align-items-end">
            <div class="col-md-7 col-sm-12 ftco-animate mb-5">
              ...
              <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Layanan Medical Check Up RSUD Blambangan</h1>
            </div>
          </div>
        </div>
      </div>
	...
	<br>
    <h2 class="text-center" style="color: #71C9CE;"><b>LAYANAN MEDICAL CHECK UP</b></h2>
	    		...
	    		<div class="col-md-6 ftco-animate pr-md-5 order-md-first">
		          ...
		          <div class="col-md-12 d-flex align-items-center">
		              ...
		              <div class="tab-pane fade show active" id="v-pills-whatwedo" role="tabpanel" aria-labelledby="v-pills-whatwedo-tab">
		              	<div>
			                <h2 class="text-center" style="color: #71C9CE"><b>MEDICAL CHECK UP</b></h2>
